...
$all_users_2= $main->getemployeeLists('', '', $search_request);

$all_users =$main->getemployeeLists($start, $perpage, $search_request);
                                            ...
                                            <div class="row">
                                                <form method="get" action="">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <input type="text" name="keywords" class="form-control" PLACEHOLDER="Emp id" value="<?php echo $_GET['keywords']; ?>" />
                            ...
                            <option value="Blocked" <?php if($_GET['status']=='Blocked'){ echo "selected"; } ?>>Blocked</option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="sea-bt pull-right">
														...
														<input type="button" name="Search" value="Clear filter" onclick="window.location='manage-employee.php';" />
                                                    </div>
	...
	?>
                                                    ...
                                                    <tr class="odd gradeX">
                                                          ...
                                                          <td>
                                                            ...
                                                            <img src="../profile_image/<?php echo $rows['profile_image'];?>" width="50" />
                                                            <?php } ?>
                                                        ...
                                                        <td>
                                                            <?php  echo ucwords($rows['fullname']);?>
                                                        </td>
                                         <td>
                                                            <?php  echo $rows['email'];?>
                                                        </td>
