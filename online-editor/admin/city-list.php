...
$all_users_2= $main->getcityLists('', '', $search_request);

$all_users =$main->getcityLists($start, $perpage, $search_request);
...
$Id= $del;
 ...
 $main->id = $Id;
$where = " where id = $Id ";
if($main->delete_single_record(cities,$where)){
...
?>
 <script src="function.js"></script>
                    ...
                    <div class="panel panel-default">					
                        <div class="panel-heading">
						 ...
						 <form method="get" action="">
							<input type="text" name="keywords"  class="form-control" PLACEHOLDER="Enter city" value="<?php echo $_GET['keywords']; ?>"/>
						...
						<div class="col-lg-3">
							...
							<option value="city-list.php">Sort by </option>
							<option value="city-list.php?Search=Search&orderby=name&order=ASC" <?php if($_GET['order']=='ASC'){ echo "selected"; } ?>>ASC</option>
                             <option value="city-list.php?Search=Search&orderby=name&order=DESC" <?php if($_GET['order']=='DESC'){ echo "selected"; } ?>>DESC</option>
						...
						<a href="city-list.php">Clear filter</a>
						...
						<?php if($_SESSION['message']!=''){?>
						 ...
						 <?php 
							...
							<form name="product_form" id="product_form" action="city-list.php" method="post">
  ...
  while($rows = mysqli_fetch_array($all_users)){
	...
	$cnt = mysqli_query($conn,"select * from states where id='".$rows['state_id']."'");	
...
<td><?php  echo $rows['name'];?></td>
										...
										<a href="add-city.php?action=edit&id=<?php echo $rows['id']; ?>">
