...
$all_users_2= $main->getcountryLists('', '', $search_request);

$all_users =$main->getcountryLists($start, $perpage, $search_request);
...
$Id= $del;
 ...
 $main->id = $Id;
$where = " where id = $Id ";
if($main->delete_single_record(countries,$where)){
                    ...
                    <div class="panel panel-default">					
                        <div class="panel-heading">
						 ...
						 <form method="get" action="">
							<input type="text" name="keywords"  class="form-control" PLACEHOLDER="Search Country" value="<?php echo $_GET['keywords']; ?>"/>
						...
						<div class="col-lg-3">
							...
							<option value="country-list.php">Sort By</option>
							<option value="country-list.php?Search=Search&orderby=name&order=ASC" <?php if($_GET['order']=='ASC'){ echo "selected"; } ?>>ASC</option>
                             <option value="country-list.php?Search=Search&orderby=name&order=DESC" <?php if($_GET['order']=='DESC'){ echo "selected"; } ?>>DESC</option>
						...
						<a href="country-list.php">Clear filter</a>
						...
						<?php if($_SESSION['message']!=''){?>
						 ...
						 <?php 
							...
							<form name="product_form" id="product_form" action="country-list.php" method="post">

                                <input type="hidden" value="" name="doaction" id="doaction" />
                                <table class="table table-striped table-bordered table-hover" id="exampless">
                                    <thead>
                                        <tr>
										<th>Sr.</th>
									     <!--   <th>Sort Name</th>-->
 ...
 // $sn =1;
  ...
  while($rows = mysqli_fetch_array($all_users)){
									...
									?>
										...
										<td><?=$sn;?></td>
										    <?php /*?><td> 
											<?php  echo ucwords($rows['sortname']);?>
</td><?php */?>
...
<a href="country.php?action=edit&id=<?php echo $rows['id']; ?>">
...
<td colspan="5">No record found</td>
              ...
              ?>
							...
							<ul class="list-inline pull-right">
						 		<?php /*?>
							<li><input class="btn btn-info" type="submit" value="Active" onclick="active_cnt(this.value);" name="active"></li>
							<li><input class="btn btn-warning" type="submit" value="Inactive" onclick="inactive_cnt(this.value);" name="inactive"></li>
							<?php */?>
