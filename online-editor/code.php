						 ...
						 <div class="row clearfix">
							<div class="form-group">
							   ...
							   <input type="reset" class="btn btn-primary" value="Reset">
							    <button  type="button" name="save_continue" id="save_continue" class="btn btn-primary">Save & Continue</button>
							   </div>
							</div>
                        <div class="row clearfix">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input name="program_name" class="form-control" id="program_name" placeholder="Enter program name.." value="<?php echo $rows['name']?>" required>	
							   </div>
                            </div>
							 <div class="col-md-12">
                                <div class="form-group">
                                   <textarea name="code" style="border: 1px solid;" class="form-control no-resize" rows=15 cols=100 onkeydown=insertTab(this,event) id="code" placeholder="Enter Your code here.." required><?php echo $rows['code']?></textarea><br/>	
							    </div>
                            </div>
							
                            <div class="col-md-12">
                                <div class="form-group">
                                     <textarea name="output" class="form-control no-resize" id="output" onkeyup="new do_resize(this);" cols="50" rows="5" placeholder="Output.." readonly="yes"><?php echo strip_tags($rows['output'])?></textarea><br/>	
