        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="dashborad.php"><i class="zmdi zmdi-home"></i> Python</a></li>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="number count-to m-b-0" data-from="0" data-to="<?php echo $totalorders['totalOrder'];?>" data-speed="2500" data-fresh-interval="700"><?php echo count($student);?> <i class="zmdi zmdi-trending-up float-right"></i></h3>
                        <p class="text-muted">Total Students</p>
                        <div class="progress">
                            <div class="progress-bar l-blush" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo count($student);?>%;"></div>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="number count-to m-b-0" data-from="0" data-to="<?php echo $totalEmployee['totalEmployee'];?>" data-speed="2500" data-fresh-interval="1000"><?php echo $totalEmployee['totalEmployee'];?> <i class="zmdi zmdi-trending-up float-right"></i></h3>
                        <p class="text-muted">Total Employee</p>
                        <div class="progress">
                            <div class="progress-bar l-green" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $totalEmployee['totalEmployee'];?>%;"></div>
                        </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="body">
                        <h3 class="number count-to m-b-0" data-from="0" data-to="<?php echo $totalStore['totalStore'];?>" data-speed="2500" data-fresh-interval="1000"><?php echo $totalStore['totalStore'];?> <i class="zmdi zmdi-trending-up float-right"></i></h3>
                        <p class="text-muted">Total Store <i class="zmdi zmdi-mood"></i></p>
                        <div class="progress">
                            <div class="progress-bar l-parpl" role="progressbar" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $totalStore['totalStore'];?>%;"></div>
                        </div>
