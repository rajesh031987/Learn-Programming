...
// get store list
		...
		function getstoreLists($start=0, $perpage=0, $searchparam){
...
$andor = 'AND';
  	...
  	//$search_sql[]= " user_fullname like '%".trim($searchparam['keywords'])."%' ";
				...
				$search_sql[]= " store_name like '%".trim($searchparam['keywords'])."%' ";
	...
	if($searchparam['fromdate']!=''){
		...
		if($searchparam['order']){
		 ...
		 $query = "select * from tbl_store where 1  $search_sql_query order by $orderby";

		 }

		 else{

		 $query = "select * from tbl_store where 1   $search_sql_query order by created_date DESC";
...
$andor = 'AND';
  	...
  	//$search_sql[]= " user_fullname like '%".trim($searchparam['keywords'])."%' ";
				...
				$search_sql[]= " emp_id like = '$searchparam[keywords]' ";
